...
```{r, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, tidy = FALSE, cache = FALSE, dev = 'svg', fig.align = 'center')
```
...
- Missensmutatsioone sisaldav tuumorsupressor valk annab vähirakkudele mingi selektsioonilise eelise.

]
.pull-right[

```{r}
knitr::include_graphics("assets/img/tsg-mutation-spectrum.png")
```
]
...
```{r}
knitr::include_graphics("assets/img/TP53-mutations.png")
```
...
```{r, out.width=400}
knitr::include_graphics("assets/img/p53hela.jpg")
```
...
```{r}
knitr::include_graphics("assets/img/p21inhibitsapoptosis.png")
```
...
- ssDNA, UV kiirgus, replikatsioonistress, kemoterapeutikumid akiveerivad ATR (*ATM–Rad3-related protein*) to Chk1 raja.
...
```{r}
knitr::include_graphics("assets/img/p53MDM2.jpg")
```
]
...
```{r}
knitr::include_graphics("assets/img/two-pathways.png")
```
...
```{r, out.width=300}
knitr::include_graphics("assets/img/Bcl2familyvalues.png")
```
...
```{r}
knitr::include_graphics("assets/img/BH3regulatsioon.png")
```
